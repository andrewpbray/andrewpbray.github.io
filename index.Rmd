...
The quiz this week will cover: visualizing data, fitting a linear model, assessing whether the
assumptions are reasonable, and inference (CIs, PIs). It will be posted this evening on moodle
and due Friday evening. You may utlize resources such as the book, the internet, notes, slides, etc.
...
Homework #5: Ch. 3 exercises 4 (only the first a and b), 5 (not a), and 8.  Due Sunday 3 pm. Project topics due next
Wednesday.
