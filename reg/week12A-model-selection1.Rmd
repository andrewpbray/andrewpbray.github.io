...
## PGA Tour
![pgatour](http://www.pgatour.com/content/dam/pgatour/editorial/2013/01/08/johnson.driver.badz.jpg)
...
plot(1:7, AICs, col = "green", pch = 16, ylab = "IC value", xlab = "order")
points(1:7, BICs, col = "red", pch = 16)
