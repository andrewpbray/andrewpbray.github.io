...
You can find these exercises in the slides, which are posted on the class website. 
...
- The plot above displays the relationship between the mean arrival delay and the mean distance travelled by every plane in the data set. It also shows the total
