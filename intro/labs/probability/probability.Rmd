...
You should see in your Environment tab that two new objects appear: `kobe` 
and `calc_streak`:

- `kobe`: a data frame of 133 observations and 6 variables, where every
row records a shot taken by Kobe Bryant. The `basket` variable in this dataset
...
in a data frame called `kobe_streak` as the `length` variable. Here we see an
example of *nesting* one function inside another.
