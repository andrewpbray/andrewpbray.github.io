...
qplot(x = birthplace, fill = literate, geom = "bar", position = "fill")
```
...
<img src="../figs/eco-freedman" width="425px" />
...
qplot(x = birthplace, fill = highincome, geom = "bar", position = "fill")
```
...
<img src="../figs/eco-freedman" width="300px" />
...
When dealing with an ecological study,
